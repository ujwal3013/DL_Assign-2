Transfer Learning has been implemented for predicting type of cancer by using InceptionV3 as a pretrained model and Chest CT Scan Image Dataset has been used to train the pretrained model. 
